...
BOARD_KERNEL_CMDLINE += ip6table_raw.raw_before_defrag=1BOARD_KERNEL_IMAGE_NAME := Image
...
TARGET_PREBUILT_KERNEL := $(DAGU_PREBUILT)/kernel/Image
TARGET_PREBUILT_DTB := $(DAGU_PREBUILT)/kernel/dtb.img
BOARD_PREBUILT_DTBOIMAGE := $(DAGU_PREBUILT)/kernel/dtbo.img

TARGET_KERNEL_CONFIG := vendor/dagu_user_defconfig
...
BOARD_PREBUILT_ODMIMAGE := $(DAGU_PREBUILT)/odm.img
BOARD_PREBUILT_VENDORIMAGE := $(DAGU_PREBUILT)/vendor.img

BOARD_DAGU_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor
BOARD_SUPER_PARTITION_SIZE := 9126805504
BOARD_SUPER_PARTITION_GROUPS := dagu_dynamic_partitions
BOARD_DAGU_DYNAMIC_PARTITIONS_SIZE := 9122611200
...
BOARD_PARTITION_LIST := $(call to-upper, $(BOARD_DAGU_DYNAMIC_PARTITIONS_PARTITION_LIST))
